...
bool CImageCanvas::DoPaint(HDC hDC, const RECT& rcPaint, CControlUI* pStopControl)
{
	...
	Gdiplus::Bitmap* bitmap = new Gdiplus::Bitmap(m_width, m_height, m_width * 4, PixelFormat32bppRGB, (BYTE*)m_data.c_str());
	...
	graphics.DrawImage(pImage, rcDst, 0, 0, m_width, m_height, UnitPixel);
	delete bitmap;
