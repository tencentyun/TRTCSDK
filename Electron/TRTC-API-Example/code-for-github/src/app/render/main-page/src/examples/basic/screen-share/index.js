    ...
    <div className="basic-scene basic-screen-share">
      <ExampleLayout
        ...
        renderDesc={() => {
          return (
            <React.Fragment>
              <p>{a18n('屏幕分享, 支持选择使用主路或辅路进行屏幕分享')}</p>
              <p>
                {a18n(
      ...
      >
        ...
        <div className="screen-share-view">
          <div className="localScreenShareWrapper share-preview-item">{a18n('本地屏幕分享预览区')}</div>
          <div className="remoteScreenShareWrapper share-preview-item">{a18n('远程屏幕分享预览区')}</div>
        </div>
      </ExampleLayout>
    </div>
  );
