      ...
      <ExampleLayout
        ...
        renderDesc={() => {
          return (
            <React.Fragment>
              <p>
                TRTC 中两个不同音视频房间中的主播，可以通过“跨房连麦”功能拉通连麦通话功能。使用此功能时， 两个主播无需退出各自原来的直播间即可进行“连麦 PK”。<br/><br/>
                例如：当房间“001”中的主播 A 通过 connectOtherRoom() 跟房间“002”中的主播 B 拉通跨房连麦后， 房间“001”中的用户都会收到主播 B 的 onUserEnter(B) 回调和 onUserVideoAvailable(B,true) 回调。 房间“002”中的用户都会收到主播 A 的 onUserEnter(A) 回调和 onUserVideoAvailable(A,true) 回调。<br/><br/>
        ...
        <div className="video-view-preview">
          <div className="connect-action-section">
            <div className="room-id-wrapper">
              当前房间号: <span className="room-id"></span>
            </div>
            <div className="user-id-wrapper">
              当前用户: <span className="user-id"></span>
            </div>
            <div className="connect-room-id-wrapper">
              连麦房间号: <input type="number" className="connect-room-id"></input>
            </div>
            <div className="connect-room-id-wrapper">
              连麦主播: <input className="connect-user-id"></input>
            </div>
            <button className="connect-room-btn">连麦</button>
          </div>
