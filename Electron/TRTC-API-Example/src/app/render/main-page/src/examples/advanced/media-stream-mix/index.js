...
const desc = (clickHandler) => (
  <React.Fragment>
    <p>
      本示例用于演示混流编码与CDN旁路直播，详细功能说明请参阅腾讯云官网文档：
      <a href="https://cloud.tencent.com/document/product/647/16827" onClick={clickHandler}>云端混流转码</a>。
    </p>
    <p>
      在<a href="https://cloud.tencent.com/document/product/647/16826" onClick={clickHandler}> CDN 直播观看 </a>
      和 <a href="https://cloud.tencent.com/document/product/647/16823" onClick={clickHandler}> 云端录制回放 </a>
      ...
      <Layout
        ...
        <div className="video-view-preview">
          ...
          <div className="video-wrapper local-screen-share">
            <div className="user-desc">
              <span className="user-type">本地屏幕分享</span>
            </div>
            <div id="localScreenShareWrapper"></div>
          </div>
        </div>
        <div className="video-mixed-wrapper">
          <div><span className="user-type">混流视频预览</span></div>
