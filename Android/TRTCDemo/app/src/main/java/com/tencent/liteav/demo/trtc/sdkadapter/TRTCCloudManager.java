...
public class TRTCCloudManager {
     ...
     */
    public TRTCCloudManager(TRTCCloud trtcCloud, TRTCCloudDef.TRTCParams trtcParams, int appScene) {
     ...
     * 美颜相关
     */
    public void onBeautyParamsChange(BeautyConfig params, int key) {
        switch (key) {
            case TRTCBeautySettingPanel.BEAUTYPARAM_BEAUTY:
                ...
                // 设置美颜风格、美颜等级
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setBeautyStyle(mBeautyStyle);
                    mTRTCCloud.getBeautyManager().setBeautyLevel(mBeautyLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_WHITE:
                ...
                // 设置美白等级
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setWhitenessLevel(mWhiteningLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_BIG_EYE:
                // 设置大眼等级
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setEyeScaleLevel(params.mBigEyeLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FACE_LIFT:
                // 设置瘦脸等级
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setFaceSlimLevel(params.mFaceSlimLevel);
                }
                break;
            ...
            case TRTCBeautySettingPanel.BEAUTYPARAM_MOTION_TMPL:
                // 设置动效
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setMotionTmpl(params.mMotionTmplPath);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_RUDDY:
                ...
                // 设置红润
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setRuddyLevel(mRuddyLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FACEV:
                // 设置 V 脸级别
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setFaceVLevel(params.mFaceVLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FACESHORT:
                // 设置短脸级别
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setFaceShortLevel(params.mFaceShortLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_CHINSLIME:
                // 设置下巴拉伸或缩短
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setChinLevel(params.mChinSlimLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_NOSESCALE:
                // 设置瘦鼻等级
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setNoseSlimLevel(params.mNoseScaleLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FILTER_MIX_LEVEL:
                ...
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_EYELIGHTEN:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setEyeLightenLevel(params.mEyeLightenLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_TOOTHWHITEN:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setToothWhitenLevel(params.mToothWhitenLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_WRINKLEREMOVE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setWrinkleRemoveLevel(params.mWrinkleRemoveLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_POUNCHREMOVE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setPounchRemoveLevel(params.mPounchRemoveLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_SMILELINESREMOVE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setSmileLinesRemoveLevel(params.mSmileLinesRemoveLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FOREHEAD:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setForeheadLevel(params.mForeheadLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_EYEDISTANCE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setEyeDistanceLevel(params.mEyeDistanceLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_EYEANGLE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setEyeAngleLevel(params.mEyeAngleLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_MOUTHSHAPE:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setMouthShapeLevel(params.mMouthShapeLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_NOSEWING:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setNoseWingLevel(params.mNoseWingLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_NOSEPOSITION:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setNosePositionLevel(params.mNosePositionLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_LIPSTHICKNESS:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setLipsThicknessLevel(params.mLipsThicknessLevel);
                }
                break;
            case TRTCBeautySettingPanel.BEAUTYPARAM_FACEBEAUTY:
                if (mTRTCCloud != null) {
                    mTRTCCloud.getBeautyManager().setFaceBeautyLevel(params.mFaceBeautyLevel);
                }
                break;
        }
    }
    ...
    /**
     * 开始录音，默认保存到 /sdcard/test/record/record.aac 中
    ...
    public boolean startRecord() {
        ...
        params.filePath = SDCARD_TEST_RECORD_RECORD_AAC;
