 ...
 * 4. {@link TRTCNewRoomActivity#startJoinRoomInternal(int, String)} 中您可以了解到进房有两种模式分别对应【腾讯云视频通话】和【万人低延时直播间】
 */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                if (sampleRate != 48000) {
                    Toast.makeText(this, "音频仅支持采样率48000，请重新选择！", Toast.LENGTH_SHORT).show();
                    mVideoFile = null;
                    needDelay = true;
                }
            } catch (Exception e) {
