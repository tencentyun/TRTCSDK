...
#import "TRTCVoiceRoomAudioConfig.h"
#import "TRTCCloud.h"
#import "TRTCCloudDef.h"

NS_ASSUME_NONNULL_BEGIN

@class  TRTCVoiceRoomCloudManager;

@protocol  TRTCVoiceRoomCloudManagerDelegate <NSObject>

@optional
- (void)roomSettingsManager:(TRTCVoiceRoomCloudManager *)manager didSetVolumeEvaluation:(BOOL)isEnabled;

@end


@interface  TRTCVoiceRoomCloudManager : NSObject

@property (weak, nonatomic) id<TRTCVoiceRoomCloudManagerDelegate> delegate;
@property (nonatomic) TRTCAppScene scene;
@property (strong, nonatomic) TRTCParams *params;
@property (strong, nonatomic, readonly) TRTCVoiceRoomAudioConfig *audioConfig;
