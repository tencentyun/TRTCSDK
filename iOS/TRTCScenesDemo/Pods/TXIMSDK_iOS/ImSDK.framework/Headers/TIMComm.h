...
@interface TIMModifyGroupInfo : TIMCodingModel
///群组 ID
...
///入群类型
@property(nonatomic,assign) TIMGroupAddOpt addOption;
...
/// 修改群成员资料
@interface TIMModifyMemberInfo : TIMCodingModel
///需要修改群成员资料的 ID
...
///群成员自定义字段，只有本人、群主、管理员可以设置
@property(nonatomic,strong) NSDictionary* customInfo;

///群成员角色，只有群主、管理员可以设置，直播大群不支持设置
@property(nonatomic,assign) TIMGroupMemberRole role;

///群成员禁言时间（s），只有群主、管理员可以设置
@property(nonatomic,assign) uint32_t silence;
