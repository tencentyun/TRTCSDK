...
- (void)refreshView:(TRTCRoleType)type {
    if (type == TRTCRoleAnchor) {
        ...
        [_micBtn setImage:[UIImage imageNamed:@"voice_mic_on"] forState:UIControlStateNormal];
        [_micBtn setImage:[UIImage imageNamed:@"voice_mic_off"] forState:UIControlStateSelected];
        [_bgmBtn setImage:[UIImage imageNamed:@"music_off"] forState:UIControlStateNormal];
        [_effectBtn setImage:[UIImage imageNamed:@"voiceroom_effector_off"] forState:UIControlStateNormal];
...
- (AudioEffectSettingView *)audioEffectView {
    if (!_audioEffectView) {
        _audioEffectView = [[AudioEffectSettingView alloc] initWithType:AudioEffectSettingViewDefault];
        [_audioEffectView setAudioEffectManager:[[TRTCCloud sharedInstance] getAudioEffectManager]];
//        __weak TRTCVoiceRoomViewController *weakSelf = self;
