//
//  VideoSelectContactViewController+CollectionView.swift
//  trtcScenesDemo
//
...
extension VideoSelectContactViewController: UICollectionViewDelegate,
UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "VideoSelectUserCollectionViewCell", for: indexPath) as! VideoSelectUserCollectionViewCell
