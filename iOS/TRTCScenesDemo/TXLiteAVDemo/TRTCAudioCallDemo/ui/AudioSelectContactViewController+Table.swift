//
//  AudioSelectContactViewController+Table.swift
//  trtcScenesDemo
//
...
class AudioSelectUserTableViewCell: UITableViewCell {
...
extension AudioSelectContactViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AudioSelectUserTableViewCell") as! AudioSelectUserTableViewCell
