...
class TRTCChatSalonTipsView: UIView {
    ...
    let tipsTableView: UITableView = {
        ...
        tableView.register(TRTCChatSalonTipsTableCell.self, forCellReuseIdentifier: "TRTCChatSalonTipsTableCell")
...
extension TRTCChatSalonTipsView: UITableViewDelegate {
    
}

extension TRTCChatSalonTipsView: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return viewModel.msgEntityList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TRTCChatSalonTipsTableCell", for: indexPath)
        if let tipsCell = cell as? TRTCChatSalonTipsTableCell {
            let model = viewModel.msgEntityList[indexPath.row]
            if model.type == CSMsgEntity.TYPE_NORMAL {
            ...
            } else if model.type == CSMsgEntity.TYPE_AGREED {
