...
class ScreenViewController: UIViewController {
    ...
    func setUpUI() {
        ...
        roomLabel.textColor = UIColor.init(red: -0.32, green: 0.66, blue: 0.4, alpha: 1)
        ...
        userNameLabel.textColor = UIColor.init(red: -0.32, green: 0.66, blue: 0.4, alpha: 1)
        ...
        enterRoomButton.backgroundColor = UIColor.init(red: -0.32, green: 0.66, blue: 0.4, alpha: 1)
        enterRoomButton .setTitle("进入房间", for: UIControl.State.normal)
        enterRoomButton.contentHorizontalAlignment = UIControl.ContentHorizontalAlignment.center
        enterRoomButton .addTarget(self, action: #selector(enterRoom), for: UIControl.Event.touchUpInside)
