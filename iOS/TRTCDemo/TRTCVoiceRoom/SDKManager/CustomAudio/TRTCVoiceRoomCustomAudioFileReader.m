...
@interface TRTCVoiceRoomCustomAudioFileReader()

@property (atomic) BOOL isStart;

@end

@implementation TRTCVoiceRoomCustomAudioFileReader
{
...
static TRTCVoiceRoomCustomAudioFileReader *_instance;

+ (instancetype)sharedInstance {
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        _instance = [[TRTCVoiceRoomCustomAudioFileReader alloc] initPrivate];
    });
    return _instance;
}
