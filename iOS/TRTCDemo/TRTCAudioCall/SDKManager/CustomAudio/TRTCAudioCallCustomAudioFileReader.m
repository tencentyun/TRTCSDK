...
@interface TRTCAudioCallCustomAudioFileReader()

@property (atomic) BOOL isStart;

@end

@implementation TRTCAudioCallCustomAudioFileReader
{
...
static TRTCAudioCallCustomAudioFileReader *_instance;

+ (instancetype)sharedInstance {
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        _instance = [[TRTCAudioCallCustomAudioFileReader alloc] initPrivate];
    });
    return _instance;
}
