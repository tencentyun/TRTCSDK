...
const DynamicRtc = dynamic(import('@components/RtcClient/improve-capture-stream-canvas-rtc-client'), { ssr: false });
          ...
          <Accordion className={styles['accordion-container']} defaultExpanded={true}>
            ...
            <AccordionDetails className={styles['accordion-details-container']}>
              ...
              <div className={styles['canvas-container']}>
                <canvas ref={canvasRef} width="260px" height="190px"></canvas>
              </div>
...
export const getStaticProps = () => {
  const result = getNavConfig('improve-capture-stream-canvas');
  return {
    props: {
      ...result,
    },
