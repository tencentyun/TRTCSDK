...
- 全平台：音频录制接口 startAudioRecording 支持录制成更多的音频格式，详见 TRTCAudioRecordingParams。
...
功能新增
- Android & Mac & iOS：支持外部接管音频播放，请参考 API: enableCustomAudioRendering。
